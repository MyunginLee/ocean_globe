...
struct MyApp : public App
{
  ...
  {    
        ...
        for (int row = 0; row < data_H; row++) {
          ...
          for (int column = 0; column < data_W; column++) {
            ...
            // {  
              ...
              pic[d].color(HSV( 0.6 + pixel.r/ 100, 0.8-pixel.r/ 300, 0.6 + atan(pixel.r/ 240)));
    ...
    addSphereWithTexcoords(earth_sphere, vid_radius, 1024, true);
    ...
    imageData[5] = Image("../texture/sst/equi_sst_2004.jpeg");
    imageData[6] = Image("../texture/sst/equi_sst_2005.jpeg");
    imageData[7] = Image("../texture/sst/equi_sst_2006.jpeg");
